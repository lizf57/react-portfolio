      ...
      <div className='grid d-flex justify-content-center m-3 p-4'>
         ...
         {/* project 1 */}
            <div className='col-lg-3 gap-1 m-1'>
               <div className='card'>
                  ...
                  <img className='card-img-top' src="/images/career-craft.png" alt="Card image"/>
         ...
         <div className='col-lg-3 m-1 gap-1'>
               <div className='card'>
                  ...
                  <img className='card-img-top' src="/images/office-organizer-img.jpeg" alt="Card image"/>
                  <div className='card-body'>
         ...
         <div className='col-lg-3 m-1 gap-1'>
               <div className='card'>
                  ...
                  <img className='card-img-top' src="/images/weather-app-img.jpeg" alt="Card image"/>
                  <div className='card-body'>
